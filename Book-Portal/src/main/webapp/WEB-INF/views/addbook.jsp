...
<body>
	...
	<div class="card rounded-3 text-black body  p-md-3 mx-md-12 "
		style="height: 50%; background-color: rgba(255, 255, 255, 0.25); backdrop-filter: blur(6px); -webkit-backdrop-filter: blur(6px); margin-bottom: 2cm; margin-right: 12cm; margin-left: 12cm; margin-top: 2cm;">
			...
			<form:form action="addBookDataItems" method="post"
			modelAttribute="book">
			<div class="container-fluid">

				<div class="title"
					style="color: tomato; text-align: center; font-size: 25px;">Add
					Book Details</div>
				<div class="form-row">
				...
				<div class="form-row">
					...
					<div class="col-sm-4">
						<form:label path="book_image" for="book_image">Book Image Url</form:label>
						<form:input path="book_image" type="text" class="form-control"
							id="book_image"  required="required" />
					</div>
					<div class="col-sm-4">
					...
					<div class="col-sm-4">
						...
						<form:input path="stockcount" type="text" class="form-control"
							id="stockcount"  required="required" />
					</div>
