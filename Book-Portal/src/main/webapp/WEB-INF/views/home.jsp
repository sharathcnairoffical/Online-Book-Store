...
<body>
	<div class="nav-wrap">
		<nav class="container nav">
			...
			<div class="nav-right">
				...
				<div class="form">
					<form action="/add">
						<a class="nav-link" href="/addBookItems"> <span>Add Books</span></a>
					</form>
				</div>
			
				<c:if test="${user != null }">
					<!-- <a href="/view-order" class="navlinks"><span
						class="material-icons pe-2 icon" style="color: white">shopping_cart</span><span>Order</span>
					</a> -->
	...
	<div class="container">
		<img src="css/images/bookstore.jpg" class="hero" alt="" srcset="" style="background-size: cover;">
			...
			<c:forEach var="book" items="${allBooks}">
					...
					<div class="card" style="width: 18rem;height: 100%;">
						...
						<div class="card-body">
							...
							<div>
								<a
									href="edit?id=${book.book_id}&title=${book.book_title}&price=${book.price}&author=${book.author}&category=${book.category}
									&stockcount=${book.stockcount}&summary=${book.summary}&image=${book.book_image}"
									class="btn btn-secondary">Edit</a>
							</div>
							<div>
								<a
									href="delete?id=${book.book_id}"
									class="btn btn-secondary" style="margin-left: 55%; margin-bottom: 90%;">Delete</a>
							</div>
						</div>
					</div>
				</a>
